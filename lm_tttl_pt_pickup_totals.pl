...
$reset_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run -mode RESET \-wait loomis lm_tttl_pt_pickup_totals 2>&1`;
$gen_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run \-wait loomis lm_tttl_pt_pickup_totals 2>&1`;
$job_info=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-logdetail loomis lm_tttl_pt_pickup_totals 2>&1`;
...
print MAIL "Subject: lm_tttl_pt_pickup_totals Messages\n\n";
