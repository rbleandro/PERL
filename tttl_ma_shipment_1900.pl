...
$reset_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run -mode RESET \-wait loomis tttl_ma_shipment_1900 2>&1`;
$gen_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run \-wait loomis tttl_ma_shipment_1900 2>&1`;
$job_info=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-logdetail loomis tttl_ma_shipment_1900 2>&1`;
...
print MAIL "Subject: Archive tttl_ma_shipment_1900 Messages\n\n";
