...
dbisql -c "uid=DBA;pwd=\`/opt/sybase/cron_scripts/getpass.pl DBA\`" -host localhost -port 2638 -nogui -onerror exit 'execute load_cmf_data_from_ase' 2>&1`;
...
Subject: ERROR: Load CMF Data from ASE...ABORTED!!
