...
$cpError = `cp /opt/sybase/tmp/\'Account Summary Details.csv\' /opt/sybase/tmp/acct_sum_det.csv`;
...
$cpError = `cp /opt/sybase/tmp/\'EA_Call Usage.csv\' /opt/sybase/tmp/EA_Call.csv`;
print "cpEroor: $cpError \n";
...
$cpError = `cp /opt/sybase/tmp/\'EquipmentRecurring Charges Details - NSB.csv\' /opt/sybase/tmp/equip_rec.csv`;
...
$cpError = `cp /opt/sybase/tmp/\'NSB Toll Free Details.csv\' /opt/sybase/tmp/nsb_detail.csv`;
...
$cpError = `cp /opt/sybase/tmp/\'OCC & OTC Details - NSB.csv\' /opt/sybase/tmp/occ_otc.csv`;
...
. /opt/sybase/IQ-15_1/IQ-15_1.sh

dbisql -c "uid=DBA;pwd=\`/opt/sybase/cron_scripts/getpass.pl DBA\`" -host localhost -port 2638 -nogui -onerror exit /opt/sybase/cron_scripts/sql/load_account_summary_detail.sql`;
...
dbisql -c "uid=DBA;pwd=\`/opt/sybase/cron_scripts/getpass.pl DBA\`" -host localhost -port 2638 -nogui -onerror exit /opt/sybase/cron_scripts/sql/load_equipment_rec_nsb.sql`;

$dbsqlOut = `. /opt/sybase/SYBASE.sh
. /opt/sybase/IQ-15_1/IQ-15_1.sh

dbisql -c "uid=DBA;pwd=\`/opt/sybase/cron_scripts/getpass.pl DBA\`" -host localhost -port 2638 -nogui -onerror exit /opt/sybase/cron_scripts/sql/load_nsb_toll_free_detail.sql`;

$dbsqlOut = `. /opt/sybase/SYBASE.sh
. /opt/sybase/IQ-15_1/IQ-15_1.sh

dbisql -c "uid=DBA;pwd=\`/opt/sybase/cron_scripts/getpass.pl DBA\`" -host localhost -port 2638 -nogui -onerror exit /opt/sybase/cron_scripts/sql/load_occ_otc_detail.sql`;

$dbsqlOut = `. /opt/sybase/SYBASE.sh
. /opt/sybase/IQ-15_1/IQ-15_1.sh

dbisql -c "uid=DBA;pwd=\`/opt/sybase/cron_scripts/getpass.pl DBA\`" -host localhost -port 2638 -nogui -onerror exit /opt/sybase/cron_scripts/sql/load_EA_Call.sql`;
