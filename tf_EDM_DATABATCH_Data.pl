...
$reset_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run -mode RESET \-wait loomis tf_EDM_DATABATCH_Data 2>&1`;
$gen_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run \-wait loomis tf_EDM_DATABATCH_Data 2>&1`;
$job_info=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-logdetail loomis tf_EDM_DATABATCH_Data 2>&1`;
...
print MAIL "Subject: tf_EDM_DATABATCH_Data Messages\n\n";
