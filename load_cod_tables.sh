...
#    /opt/sybase/SYBSsa9/bin/dbisql -c "dsn=AMER_ASA" -nogui load_perv_outstand_cod.sql
    /opt/sybase/SYBSsa9/bin/dbisql -c "dsn=AMER_ASA" -nogui load_perv_set_cod.sql
#    /opt/sybase/SYBSsa9/bin/dbisql -c "dsn=AMER_ASA" -nogui load_perv_daily_cod_settlements.sql
