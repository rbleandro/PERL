...
$reset_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run -mode RESET \-wait loomis lm_SQL_PremInv_Purge_And_Load 2>&1`;
$gen_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run \-wait loomis lm_SQL_PremInv_Purge_And_Load 2>&1`;
$job_info=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-logdetail loomis lm_SQL_PremInv_Purge_And_Load 2>&1`;
...
print MAIL "Subject: Premium Inventory lm_SQL_PremInv_Purge_And_Load Messages\n\n";
