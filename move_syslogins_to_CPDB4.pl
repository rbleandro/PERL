...
isql -Usa -P\`/opt/sap/cron_scripts/getpass.pl sa\` -SCPDB4 -b -n<<EOF 2>&1
...
#Copy logins from CPDB4
$bcp_error = `. /opt/sap/SYBASE.sh
bcp master..syslogins in /opt/sap/bcp_data/master/syslogins_CPDB2.dat -Usa -P\`/opt/sap/cron_scripts/getpass.pl sa\` -SCPDB4 -c -F4`;
