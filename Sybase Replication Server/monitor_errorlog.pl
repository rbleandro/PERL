...
while (<ERRORLOG>){
   if($getNextLine == 1){
      ...
      if(($tooManyErrors < 5 ) && ($firstLine !~ /Deadlock/ || $firstLine !~ /IGNORE/i || $firstLine !~ /WARN/i || $firstLine !~ /Ambiguous/ || $secondLine !~ /IGNORE/i || $secondLine !~ /WARN/i) && ($firstLine !~ /WARNING #5185/ && $secondLine !~ /WARNING #5185/) && ($firstLine !~ /Message: 1708/ && $secondLine !~ /Message: 1708/)){
