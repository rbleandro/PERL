...
$reset_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run -mode RESET \-wait loomis sybase_cp_data2_to_jcc 2>&1`;
$run_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run \-wait loomis sybase_cp_data2_to_jcc 2>&1`;
$job_info=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-logdetail loomis sybase_cp_data2_to_jcc 2>&1`;
...
print MAIL "Subject: sybase_cp_data2_to_jcc Messages\n\n";
