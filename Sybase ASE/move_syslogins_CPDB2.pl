...
bcp master..syslogins out /opt/sybase/bcp_data/master/syslogins_CPDB1.dat -Usa -P\`/opt/sybase/cron_scripts/getpass.pl sa\` -SCPDB1 -c`;
...
bcp master..syslogins in /opt/sybase/bcp_data/master/syslogins_CPDB1.dat -Usa -P\`/opt/sybase/cron_scripts/getpass.pl sa\` -SCPDB2 -c -F3`;
