...
my $grep="";
$grep = `grep -iRl "compilation" /opt/sap/cron_scripts/cron_logs ; grep -iRl "No such file" /opt/sap/cron_scripts/cron_logs ; grep -iRl "not found" /opt/sap/cron_scripts/cron_logs ; grep -iRl "denied" /opt/sap/cron_scripts/cron_logs;`;
