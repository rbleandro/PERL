...
$reset_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run -mode RESET \-wait loomis rev_hist_bcxref_OLD_seq 2>&1`;
$gen_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run \-wait loomis rev_hist_bcxref_OLD_seq 2>&1`;
$job_info=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-logdetail loomis rev_hist_bcxref_OLD_seq 2>&1`;
...
print MAIL "Subject: Archive rev_hist_bcxref_OLD_seq Messages\n\n";
