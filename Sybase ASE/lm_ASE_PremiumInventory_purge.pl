...
$reset_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run -mode RESET \-wait loomis lm_ASE_PremiumInventory_purge 2>&1`;
$gen_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run \-wait loomis lm_ASE_PremiumInventory_purge 2>&1`;
$job_info=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-logdetail loomis lm_ASE_PremiumInventory_purge 2>&1`;
...
print MAIL "Subject: Premium Inventory lm_ASE_PremiumInventory_purge Messages\n\n";
