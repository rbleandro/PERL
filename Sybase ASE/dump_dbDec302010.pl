...
print "\n***Removing existing dumps from directories...***\n";
`rm /opt/sybase/db_backups/stripe11/cdpvkm.dmp_$currDay`;
...
#            $sshError_test = `ssh CPSYBTEST /opt/sybase/cron_scripts/load_db.pl CPSYBTEST cpscan $startDay $startHour $startMin`;
            print $sshError_test."\n\n";
