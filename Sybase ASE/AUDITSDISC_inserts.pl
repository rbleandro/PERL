...
$reset_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run -mode RESET \-wait loomis AUDITSDISC_inserts 2>&1`;
$gen_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run \-wait loomis AUDITSDISC_inserts 2>&1`;
$job_info=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-logdetail loomis AUDITSDISC_inserts 2>&1`;
...
print MAIL "Subject: cmf_data_lm\AUDITSDISC_inserts Messages\n\n";
