...
$reset_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run -mode RESET \-wait loomis scanvbill_to_sybase 2>&1`;
$gen_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run \-wait loomis scanvbill_to_sybase 2>&1`;
$job_info=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-logdetail loomis scanvbill_to_sybase 2>&1`;
...
print MAIL "Subject: cmf_data_lm\\scanvbill_to_sybase Messages\n\n";
