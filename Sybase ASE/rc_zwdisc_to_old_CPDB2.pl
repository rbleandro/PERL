...
$reset_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run -mode RESET \-wait loomis rc_zwdisc_to_old_CPDB2 2>&1`;
$gen_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run \-wait loomis rc_zwdisc_to_old_CPDB2 2>&1`;
$job_info=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-logdetail loomis rc_zwdisc_to_old_CPDB2 2>&1`;
...
print MAIL "Subject: rc_zwdisc_to_old_CPDB2 Messages\n\n";
