...
$reset_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run -mode RESET \-wait loomis SENTTOSP3_to_pms_summary 2>&1`;
$gen_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run \-wait loomis SENTTOSP3_to_pms_summary 2>&1`;
$job_info=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-logdetail loomis SENTTOSP3_to_pms_summary 2>&1`;
...
print MAIL "Subject: cmf_data_lm\SENTTOSP3_to_pms_summary Messages\n\n";
