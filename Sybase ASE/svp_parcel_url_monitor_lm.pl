...
where status_date > '$date_flag' and job_name = 'Loomis Parcel Evaluation' and job_status = 'complete'
...
if ($found >= 1){
print "found it";
`touch /tmp/svp_lm_p_completed`;
 `/usr/sbin/sendmail -t -i <<EOF
To: kkotur\@canpar.com
Subject: Loomis svp_url Parcel trigger completed...
==============================================
$sqlMsg
==============================================
