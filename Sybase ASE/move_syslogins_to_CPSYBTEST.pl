...
bcp master..syslogins out /opt/sybase/bcp_data/master/syslogins_CPDB2.dat -Usa -P\`/opt/sybase/cron_scripts/getpass.pl sa\` -SCPDB2 -c`;
...
bcp master..syslogins in /opt/sybase/bcp_data/master/syslogins_CPDB2.dat -Usa -P\`/opt/sybase/cron_scripts/getpass.pl sa\` -SCPSYBTEST -c -F3`;
