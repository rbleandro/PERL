...
bcp mpr_data_lm..gl_data in /opt/sap/bcp_data/mpr_data_lm/gl_extract/gl_data_lm.csv -Ucronmpr -S$prodserver -P\`/opt/sap/cron_scripts/getpass.pl cronmpr\` -c -t","  -r"\r\n" -b1000`;
}else{
