...
$reset_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run -mode RESET \-wait loomis sybase_cp_data1_to_mtrlsrt 2>&1`;
$run_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run \-wait loomis sybase_cp_data1_to_mtrlsrt 2>&1`;
$job_info=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-logdetail loomis sybase_cp_data1_to_mtrlsrt 2>&1`;
...
print MAIL "Subject: sybase_cp_data1_to_mtrlsrt Messages\n\n";
