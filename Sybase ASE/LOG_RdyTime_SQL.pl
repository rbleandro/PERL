...
$reset_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run -mode RESET \-wait loomis LOG_RdyTime_SQL 2>&1`;
$run_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run \-wait loomis LOG_RdyTime_SQL 2>&1`;
$job_info=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-logdetail loomis LOG_RdyTime_SQL 2>&1`;
...
print MAIL "Subject: LOG_RdyTime_SQL Messages\n\n";
