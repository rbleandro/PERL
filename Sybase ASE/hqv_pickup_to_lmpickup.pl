...
$reset_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run -mode RESET \-wait loomis pickup_to_lmpickup 2>&1`;
$gen_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run \-wait loomis pickup_to_lmpickup 2>&1`;
$job_info=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-logdetail loomis pickup_to_lmpickup 2>&1`;
...
print MAIL "Subject: HQVDEV_SYBTEST pickup_to_lmpickup Messages\n\n";
