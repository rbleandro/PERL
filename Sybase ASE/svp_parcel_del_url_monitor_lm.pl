...
where status_date > '$date_flag' and job_name = 'Loomis Parcel Expected Delivery Date Evaluation' and job_status = 'complete'
...
if ($found >= 1){
`touch /tmp/svp_lm_d_completed`;
 `/usr/sbin/sendmail -t -i <<EOF
To: kkotur\@canpar.com
Subject: svp_lm_url Del trigger completed...
==============================================
$sqlMsg
==============================================
