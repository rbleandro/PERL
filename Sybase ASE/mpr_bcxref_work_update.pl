...
print "mpr_bcxref_work_update_lod_procs StartTime: $currTime, Hour: $startHour, Min: $startMin\n";
...
$currTime = localtime();
print "mpr_bcxref_work_update_lod_procs FinTime: $currTime\n";

`touch /tmp/mpr_bcxref_work_update_lod_procs_done`;
