...
#---------------------------------------------------------------------------------#
#Jul 22,15	Amer Khan       Originally created                                #
#                                                                                 #
###################################################################################
...
where status_date > '$date_flag' and job_name = 'Canpar Parcel Evaluation' and job_status = 'complete'
...
if ($found >= 1){
print "found it";
`touch /tmp/svp_cp_p_completed`;
 `/usr/sbin/sendmail -t -i <<EOF
To: kkotur\@canpar.com
Subject: Canpar svp_url Parcel trigger completed...
==============================================
$sqlMsg
==============================================
