...
$reset_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run -mode RESET \-wait loomis LM_JCC_VIRT_ScanLink_seq 2>&1`;
$gen_msg=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-run \-wait loomis LM_JCC_VIRT_ScanLink_seq 2>&1`;
$job_info=`C\:\/IBM\/InformationServer\/Server\/DSEngine\/bin\/dsjob.exe \-logdetail loomis LM_JCC_VIRT_ScanLink_seq 2>&1`;
...
print MAIL "Subject: LM_JCC_VIRT_ScanLink_seq\n\n";
